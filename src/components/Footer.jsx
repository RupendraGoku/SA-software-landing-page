      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 mb-16">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-zinc-400 text-sm leading-relaxed mb-8 max-w-xs">{content.brand.description}</p>
            {/* Socials */}
            ...
            <div key={group.title}>
              ...
              <ul className="space-y-4">
                {group.links.map((link) => (
                  <li key={link}>
                    <a href="#" className="text-sm text-zinc-400 hover:text-indigo-400 transition-colors">
                      {link}
                    </a>
                  </li>
                ))}
          ...
          <div className="lg:col-span-1">
            <h4 className="text-white font-semibold mb-6">{content.newsletter.title}</h4>
            <p className="text-sm text-zinc-400 mb-4">{content.newsletter.description}</p>
            <div className="flex flex-col gap-2">
              <input
                type="email"
                placeholder={content.newsletter.placeholder}
                className="w-full px-4 py-2 rounded-lg bg-white/5 border border-white/10 text-white text-sm focus:outline-none focus:border-indigo-500 transition-colors"
              />
        ...
        {/* Bottom Bar */}
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between text-sm text-zinc-500">
